 ...
 *
 */
class BladOsiagnieciaLimitu extends JDialog implements ActionListener {
	 ...
	 */
	public BladOsiagnieciaLimitu(){
		this.setSize(369,125);
	...
	private JPanel utworzPanelCentralny(){
		...
		lblNaglowek=new JLabel(new ImageIcon("images/naglowek_blad4.png"));
		
		lblTresc=new JLabel(new ImageIcon("images/tresc_blad4.png"));
		
		lblWypelnienie=new JLabel(new ImageIcon("images/wypelnienie.png"));

		lblStopka=new JLabel(new ImageIcon("images/blad_ramka_dolna4.png"));
